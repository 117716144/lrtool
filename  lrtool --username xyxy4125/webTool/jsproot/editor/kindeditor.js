...
KE.setting = {
	...
	cssPath : '',
	skinsPath : '/editor/skins/',
	pluginsPath : '/editor/plugins/',
	minWidth : 200,
	minHeight : 100,
	minChangeSize : 5,
...
KE.plugin['about'] = {
	click : function(id) {
		...
		var dialog = new KE.dialog({
			id : id,
			cmd : 'about',
			file : '/editor/plugins/about.html',
			width : 300,
			height : 70,
			loadingMode : true,
			title : KE.lang['about'],
...
KE.plugin['plainpaste'] = {
	click : function(id) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : 'plainpaste',
			file : '/editor/plugins/plainpaste.html',
			width : 450,
			height : 300,
			loadingMode : true,
...
KE.plugin['wordpaste'] = {
	click : function(id) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : 'wordpaste',
			file : '/editor/plugins/wordpaste.html',
			width : 450,
			height : 300,
			loadingMode : true,
...
KE.plugin['flash'] = {
	...
	click : function(id) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : 'flash',
			file : '/editor/plugins/flash.html',
			width : 400,
			height : 140,
			loadingMode : true,
			title : KE.lang['flash'],
...
KE.plugin['image'] = {
	...
	click : function(id) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : 'image',
			file : '/editor/plugins/image/image.html',
			width : 400,
			height : 220,
			loadingMode : true,
			title : KE.lang['image'],
...
KE.plugin['link'] = {
	...
	click : function(id) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : 'link',
			file : '/editor/plugins/link/link.html',
			width : 400,
			height : 90,
			loadingMode : true,
			title : KE.lang['link'],
...
KE.plugin['media'] = {
	...
	click : function(id) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : 'media',
			file : '/editor/plugins/media.html',
			width : 400,
			height : 170,
			loadingMode : true,
			title : KE.lang['media'],
...
KE.plugin['advtable'] = {
	...
	click : function(id, mode) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : cmd,
			file : '/editor/plugins/advtable/advtable.html?mode=' + mode,
			width : 420,
			height : 220,
			loadingMode : true,
