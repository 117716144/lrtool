...
<title>搜索引擎反向链接 - 站长工具 - 傻人工具 - lrtool.net - 致力SEO简单流程化！</title>
...
<div class="conent">
 ...
 <div class="totop">
     <dl class="tbox">
     <dt>欢迎您使用本站的搜索引擎反向链接 工具，如果您觉得本站对您有帮助，请收藏或者推荐给您的朋友。</dt>
      <dd class="tc"><form method="post" target="_top" action="siteLinkAction.action">请输入要查询的网址: <font face="Arial">http://</font> <input type="text" name="shoulu_domain" size="60" id="shoulu_domain" value="<s:property value='shoulu_domain'/>" class="inp_t">&nbsp;<input type="submit" value="开始查询" class="sb_c"><br />
