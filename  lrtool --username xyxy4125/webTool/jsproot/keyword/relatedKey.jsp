...
<div class="main">
	...
	<dl class="clist">
		   <dt><strong>搜索引擎相关关键词查询</strong></dt>
		      	<dd><form method="post" target="_blank" action="relatedKey.action"><input name="keyword" id="key" type="text" size="65" value="<s:property value='keyword'/>" class="inp">&nbsp;<input type="submit" value="开始查询"  class="sec"><br />
                </dd>
		</dl>
<table>
