...
<div style="display:none"><ul><s:if test="pageCount<=9"><s:bean name="org.apache.struts2.util.Counter" id="counter">  
<s:param name="first"><s:property value="1"/></s:param><s:param name="last"><s:property value="pageCount"/></s:param>
<s:iterator><li><a href="/lrshare/<s:property/>.html"><s:property/></a></li></s:iterator>
...
<s:param name="last"><s:property value="curpage-4+8"/></s:param><s:iterator><li><li><a href="/lrshare/<s:property/>.html"><s:property/></a></li></li></s:iterator>
</s:bean>
</s:else>
</ul>   
</div>
...
var PageClick = function(cnum) {
    location.href ="/lrshare/"+cnum+".html";
}
</script>
