function checknum(obj,frm)
{
	if(obj.checked == false)
	{
		
		frm.mum.value = parseInt(frm.mum.value) - 1;
	}
	else
	{
		...
		if(parseInt(frm.mum.value) > 3)
		{ 
			frm.mum.value = 3;
			obj.checked = false;
			//var ser_arr = document.getElementsByName("se")
			//for(var a=0;a<ser_arr.length;a++)
			//{
				//if(ser_arr[a].checked == true)
				//{
					//ser_arr[a].checked = false;
					//break;
				//}
			//}
			//alert("Äú×î¶àÖ»ÄÜÑ¡ÔñÈý¸ö£¡");
		}
	}
}
